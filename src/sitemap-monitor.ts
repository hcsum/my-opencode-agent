...
const DEFAULT_WATCHLIST_PATH = "notes/sitemap-watchlist.csv";
...
async function main(): Promise<void> {
  ...
  if (targets.length === 0) {
    throw new Error(
      "No sitemap targets found. Add rows to notes/sitemap-watchlist.csv or pass --target site=https://example.com/sitemap.xml",
    );
  }
